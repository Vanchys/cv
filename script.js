// --- DATOS DEL PORTAFOLIO (EDITA AQUÍ) ---
        ...
        function renderContent() {
            ...
            // Hero
            html += `
                <section id="hero" class="hero-section" style="min-height:100svh;display:flex;align-items:center;justify-content:center;overflow:hidden;">
                    <div style="max-width:48rem;width:100%;margin:0 auto;text-align:center;padding:0 1rem;" class="reveal-base reveal-zoom">
                        <div class="hero-image-wrap floating" style="position:relative;display:inline-block;">
                    ...
                    `<div style="font-size:3rem;font-weight:700;" class="gradient-text">${portfolioData.personal.initials}</div>`
                        ...
                        <div class="hero-text-wrap">
                            ...
                            <p class="hero-location-text" style="font-size:0.95rem;color:#9ca3af;">
                                ${portfolioData.personal.age_location}
                            </p>
                        </div>
                        <!-- Texto bio retirado para no generar espacios invisibles -->
                        <div class="hero-btn-group" style="display:flex;flex-direction:column;align-items:center;width:100%;max-width:280px;margin:0 auto;">
